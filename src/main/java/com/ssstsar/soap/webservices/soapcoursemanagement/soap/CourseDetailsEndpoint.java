package com.ssstsar.soap.webservices.soapcoursemanagement.soap;
...
import com.ssstsar.courses.DeleteCourseDetailsRequest;
import com.ssstsar.courses.DeleteCourseDetailsResponse;
import com.ssstsar.courses.GetAllCourseDetailsRequest;
import com.ssstsar.courses.GetAllCourseDetailsResponse;
...
import com.ssstsar.soap.webservices.soapcoursemanagement.soap.service.CourseDetailsService.Status;
...
public class CourseDetailsEndpoint {
	...
	private com.ssstsar.courses.Status mapStatus(Status status) {
		if (status == Status.FAILURE)
			return com.ssstsar.courses.Status.FAILURE;
		return com.ssstsar.courses.Status.SUCCESS;
	}
}
